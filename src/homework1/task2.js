...
function extractSmallPlanets(planetsObject, boundaryValue) {
    var arrayOfSmallPlanets = planets.results.filter(planet => planet.diameter<=10000);

    console.log('Number of small planets: ' + arrayOfSmallPlanets.length);
      return [];
}
...
function extractBigPlanets(planetsObject, boundaryValue) {
    var arrayOfBigPlanets = planets.results.filter(planet => planet.diameter>10000);

    console.log('Number of big planets: ' + arrayOfBigPlanets.length);
    return [];
}
